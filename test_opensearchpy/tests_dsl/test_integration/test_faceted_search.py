...
from newopensearchpy import A, Boolean, Date, Document, Keyword
from newopensearchpy.faceted_search import (
    DateHistogramFacet,
    FacetedSearch,
    NestedFacet,
    RangeFacet,
...
def test_empty_search_finds_everything(
    ...
    assert [
        ("newopensearchpy", 40, False),
        ("test_opensearch_dsl", 35, False),
        ("newopensearchpy/query.py", 19, False),
        ("test_opensearch_dsl/test_search.py", 15, False),
        ("newopensearchpy/utils.py", 14, False),
        ("test_opensearch_dsl/test_query.py", 13, False),
        ("newopensearchpy/search.py", 12, False),
        ("newopensearchpy/aggs.py", 11, False),
        ("test_opensearch_dsl/test_result.py", 5, False),
        ("newopensearchpy/result.py", 3, False),
    ] == r.facets.files
