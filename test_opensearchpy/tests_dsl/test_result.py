...
from newopensearchpy import Date, Document, Object, Search, response
from newopensearchpy.aggs import Terms
from newopensearchpy.response.aggs import AggResponse, Bucket, BucketData
