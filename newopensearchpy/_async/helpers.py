...
logger = logging.getLogger("newopensearchpy.helpers")
...
async def async_streaming_bulk(
    ...
    **kwargs
    ...
    :func:`~newopensearchpy.helpers.async_bulk` which is a wrapper around streaming
    ...
    :arg client: instance of :class:`~newopensearchpy.AsyncOpenSearch` to use
...
async def async_bulk(
    ...
    """
    Helper for the :meth:`~newopensearchpy.AsyncOpenSearch.bulk` api that provides
    ...
    using the :func:`~newopensearchpy.helpers.async_streaming_bulk` helper which will
    ...
    :func:`~newopensearchpy.helpers.async_streaming_bulk` which is used to execute
    the operation, see :func:`~newopensearchpy.helpers.async_streaming_bulk` for more
    accepted parameters.
    """
    success, failed = 0, 0
...
async def async_scan(
    ...
    **kwargs
    ...
    :meth:`~newopensearchpy.AsyncOpenSearch.scroll` api - a simple iterator that
    ...
    :arg client: instance of :class:`~newopensearchpy.AsyncOpenSearch` to use
    :arg query: body for the :meth:`~newopensearchpy.AsyncOpenSearch.search` api
    ...
    :arg scroll_kwargs: additional kwargs to be passed to
        :meth:`~newopensearchpy.AsyncOpenSearch.scroll`

    Any additional keyword arguments will be passed to the initial
    :meth:`~newopensearchpy.AsyncOpenSearch.search` call::
...
async def async_reindex(
    ...
    Since ``2.3`` a :meth:`~newopensearchpy.AsyncOpenSearch.reindex` api is
    ...
    :arg client: instance of :class:`~newopensearchpy.AsyncOpenSearch` to use (for
    ...
    :arg scan_kwargs: additional kwargs to be passed to
        :func:`~newopensearchpy.helpers.async_scan`
    :arg bulk_kwargs: additional kwargs to be passed to
        :func:`~newopensearchpy.helpers.async_bulk`
    """
