...
def get_host_info(node_info, host):
    ...
    information needs to be provided for the :class:`~newopensearchpy.Connection`
...
class Transport(object):
    ...
    def __init__(
        ...
        **kwargs
        ...
        :arg connection_class: subclass of :class:`~newopensearchpy.Connection` to use
        :arg connection_pool_class: subclass of :class:`~newopensearchpy.ConnectionPool` to use
    ...
    def add_connection(self, host):
        """
        Create a new :class:`~newopensearchpy.Connection` instance and add it to the pool.
    ...
    def get_connection(self):
        """
        Retrieve a :class:`~newopensearchpy.Connection` instance from the
        :class:`~newopensearchpy.ConnectionPool` instance.
        """
    ...
    def mark_dead(self, connection):
        ...
        :arg connection: instance of :class:`~newopensearchpy.Connection` that failed
        """
    ...
    def perform_request(self, method, url, headers=None, params=None, body=None):
        ...
        :arg headers: dictionary of headers, will be handed over to the
            underlying :class:`~newopensearchpy.Connection` class
        :arg params: dictionary of query parameters, will be handed over to the
            underlying :class:`~newopensearchpy.Connection` class for serialization
