...
from newopensearchpy.helpers import scan
...
class Request(object):
    ...
    def using(self, client):
        ...
        :arg client: an instance of ``newopensearchpy.OpenSearch`` to use or
            an alias to look up in ``newopensearchpy.connections``
...
class Search(Request):
    ...
    def scan(self):
        ...
        pass to the underlying ``scan`` helper from ``newopensearchpy``
...
class MultiSearch(Request):
    """
    Combine multiple :class:`~newopensearchpy.Search` objects into a single
    request.
    """
    ...
    def add(self, search):
        """
        Adds a new :class:`~newopensearchpy.Search` object to the request::
