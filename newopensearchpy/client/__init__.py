...
class OpenSearch(object):
    ...
    :class:`~newopensearchpy.client.CatClient`,
    :class:`~newopensearchpy.client.ClusterClient`,
    :class:`~newopensearchpy.client.IndicesClient`,
    :class:`~newopensearchpy.client.IngestClient`,
    :class:`~newopensearchpy.client.NodesClient`,
    :class:`~newopensearchpy.client.SnapshotClient` and
    :class:`~newopensearchpy.client.TasksClient` respectively. This is the
    ...
    in :class:`~newopensearchpy.Transport`)::
    ...
    certificates (see :class:`~newopensearchpy.Urllib3HttpConnection` for
    ...
    optionally (see :class:`~newopensearchpy.Urllib3HttpConnection` for
    detailed description of the options)::
    ...
    (see :class:`~newopensearchpy.Urllib3HttpConnection` for
    detailed description of the options)::
    ...
    <https://github.com/opensearch-project/opensearch_py_new/blob/master/opensearch/serializer.py#L24>`_
    ...
    def __init__(self, hosts=None, transport_class=Transport, **kwargs):
        ...
        :arg hosts: list of nodes, or a single node, we should connect to.
            ...
            the entire dictionary will be passed to the :class:`~newopensearchpy.Connection`
            class as kwargs, or a string in the format of ``host[:port]`` which will be
            translated to a dictionary automatically.  If no value is given the
            :class:`~newopensearchpy.Connection` class defaults will be used.

        :arg transport_class: :class:`~newopensearchpy.Transport` subclass to use.

        :arg kwargs: any additional arguments will be passed on to the
            :class:`~newopensearchpy.Transport` class and, subsequently, to the
            :class:`~newopensearchpy.Connection` instances.
        """
