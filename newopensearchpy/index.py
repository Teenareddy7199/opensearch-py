...
class Index(object):
    ...
    def mapping(self, mapping):
        ...
        :class:`~newopensearchpy.Mapping`) with this index.
    ...
    def document(self, document):
        """
        Associate a :class:`~newopensearchpy.Document` subclass with an index.
        This means that, when this index is created, it will contain the
    ...
    def analyzer(self, *args, **kwargs):
        ...
        Example::
            ...
            from newopensearchpy import analyzer, tokenizer
    ...
    def search(self, using=None):
        """
        Return a :class:`~newopensearchpy.Search` object searching over the
    ...
    def updateByQuery(self, using=None):
        """
        Return a :class:`~newopensearchpy.UpdateByQuery` object searching over the index
