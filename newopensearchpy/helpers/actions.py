...
def expand_action(data):
    ...
    :meth:`~newopensearchpy.OpenSearch.bulk` api.
    """
...
def streaming_bulk(
    ...
    **kwargs
    ...
    :func:`~newopensearchpy.helpers.bulk` which is a wrapper around streaming
    ...
    :arg client: instance of :class:`~newopensearchpy.OpenSearch` to use
...
def bulk(client, actions, stats_only=False, ignore_status=(), *args, **kwargs):
    """
    Helper for the :meth:`~newopensearchpy.OpenSearch.bulk` api that provides
    ...
    using the :func:`~newopensearchpy.helpers.streaming_bulk` helper which will
    ...
    :func:`~newopensearchpy.helpers.streaming_bulk` which is used to execute
    the operation, see :func:`~newopensearchpy.helpers.streaming_bulk` for more
    accepted parameters.
    """
    success, failed = 0, 0
...
def scan(
    ...
    **kwargs
    ...
    :meth:`~newopensearchpy.OpenSearch.scroll` api - a simple iterator that
    ...
    :arg client: instance of :class:`~newopensearchpy.OpenSearch` to use
    :arg query: body for the :meth:`~newopensearchpy.OpenSearch.search` api
    ...
    :arg scroll_kwargs: additional kwargs to be passed to
        :meth:`~newopensearchpy.OpenSearch.scroll`

    Any additional keyword arguments will be passed to the initial
    :meth:`~newopensearchpy.OpenSearch.search` call::
...
def reindex(
    ...
    Since ``2.3`` a :meth:`~newopensearchpy.OpenSearch.reindex` api is
    ...
    :arg client: instance of :class:`~newopensearchpy.OpenSearch` to use (for
    ...
    :arg scan_kwargs: additional kwargs to be passed to
        :func:`~newopensearchpy.helpers.scan`
    :arg bulk_kwargs: additional kwargs to be passed to
        :func:`~newopensearchpy.helpers.bulk`
    """
