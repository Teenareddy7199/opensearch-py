...
from newopensearchpy.exceptions import NotFoundError, RequestError
...
class Document(ObjectBase):
    ...
    def search(cls, using=None, index=None):
        """
        Create an :class:`~newopensearchpy.Search` instance that will search
        over this ``Document``.
        """
        return Search(
