...
class ConnectionSelector(object):
    ...
    *currently* live connections to choose from.
    ...
    :class:`~newopensearchpy.Transport` as `hosts` param and the same that is
...
class ConnectionPool(object):
    """
    Container holding the :class:`~newopensearchpy.Connection` instances,
    managing the selection process (via a
    :class:`~newopensearchpy.ConnectionSelector`) and dead connections.

    It's only interactions are with the :class:`~newopensearchpy.Transport` class
    ...
    def __init__(
        ...
        **kwargs
        ...
        :arg connections: list of tuples containing the
            :class:`~newopensearchpy.Connection` instance and it's options
        ...
        :arg selector_class: :class:`~newopensearchpy.ConnectionSelector`
